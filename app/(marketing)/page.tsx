  ...
  return (
    <div className="flex items-center justify-center flex-col">
      ...
      headingFont.className)}>
        ...
        from-fuchsia-600 to-pink-600 text-white px-4 p-2 rounded-md
        pb-4 w-fit">
          work forward
        </div>
      </div>
      <div className={cn(
        ...
        From high rises to the home office, the way your 
          works is unique - accomplished it all with Taskify
      </div>
